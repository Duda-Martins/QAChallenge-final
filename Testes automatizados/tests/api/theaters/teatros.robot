...
CT024 - CRUD de teatro por Admin (sucesso)
    [Tags]    CT024    teatro    alta    allure.tms:CIN-59
    Logar usuario admin
...
CT025 - Validação de payload inválido ao criar teatro
    [Tags]    CT025    teatro    media    allure.tms:CIN-60
    Logar usuario admin
...
CT026 - Bloqueio de CRUD de teatro por usuário comum
    [Tags]    CT026    teatro    baixa    allure.tms:CIN-61
    Logar usuario comum
...
CT027 - Bloqueio ao tentar excluir teatro com sessões ativas
    [Tags]    CT027    teatro    media    allure.tms:CIN-62
    Logar usuario admin
