...
CT037 - Excluir usuário sem reservas como admin
    [Tags]    CT037    deleteUser    media    allure.issue:CIN-114    allure.tms:QALITY-CIN-72
    Logar usuario admin
...
CT036 - Editar dados de um usuário para promovê-lo à admin
    [Tags]    CT036    updateUser    alta    allure.issue:CIN-115    allure.tms:QALITY-CIN-71
    Logar usuario admin
...
CT039 - Bloqueio de acesso aos endpoints de usuários por usuário comum
    [Tags]    CT039    user    alta    allure.issue:CIN-116    allure.tms:QALITY-CIN-74
    Logar usuario comum
